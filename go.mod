...
require (
	...
	github.com/pablintino/testing-go v0.0.0
...
replace github.com/pablintino/testing-go v0.0.0 => ../testing-go

replace github.com/pablintino/commons-go v0.0.0 => ../commons-go
...
require (
	...
	github.com/pablintino/commons-go v0.0.0 // indirect
